...
{
    let sql = "SELECT planning.id, id_contrat, id_proprietaire, id_petsitter , planning.date_debut, planning.date_fin, contrat.date_creation FROM planning INNER JOIN contrat ON planning.id_contrat=contrat.id WHERE planning.id_petsitter=$1 AND contrat.est_termine=false" 

    ...
    render () {
        ...
        return (
            ...
            <div>
                ...
                <form id='form-test'>
                    <InputComponent type='checkbox' text='Garder Chez le PettSitter' id='8' name='Garder Chez le PettSitter' value='1' />
                    <InputComponent type='checkbox' text='Garder chez vous' id='9' name='Garder chez vous' value='2' />
                    <InputComponent type='checkbox' text='Promenade' id='1' name='Promenade' value='3' />
                    ...
                    <InputComponent type='checkbox' text='Petit (0-15 kg)' id='2' name='Petit (0-15 kg)' value='1' />
                    <InputComponent type='checkbox' text='Moyen (16-40 kg)' id='3' name='Moyen (16-40 kg)' value='2' />
                    <InputComponent type='checkbox' text='Grand (41-100 kg)' id='4' name='Grand (41-100 kg)' value='3' />

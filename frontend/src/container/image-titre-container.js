    ...
    render () {
        return (
            <div className='row mb-3'>
                ...
                <ImageTitre classDiv='col-lg-4' src='src/img/image_site/icone/avis.png' classCss='rounded-circle mx-auto ' titre='beneficier de la garantie rover d une assistance 24/7 et d une protection de reservation' />
            </div>
